...
export const HomePage = () => {
  return (
      ...
      <div className="home-page" style={{margin:"0 auto"}}>
        <Link to="/video-listing-page" style={{textDecoration:"none",color:"#22fcd0",textAlign:"center",fontSize:"30px"}}>
           <div className="landing-video">
              <div class="custom-shape-divider-top-1722188633">
              ...
              <div className="content">
                    <h3>Your one stop entertainment Solution,</h3><img src="./ApuTVLogo.png" alt="logoname"/>
              </div>
            </div>
